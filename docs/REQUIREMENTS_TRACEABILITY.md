...
| 37 | Tests | `apps/api/tests/*.py`, `tests/test_e2e.py`, `apps/web/src/**/*.test.{ts,tsx}` (new) | — | — | Backend: 37/37 passing (was 35 at audit start, +2 new regression tests). Frontend: 13/13 passing via newly-added `npm test` (Vitest + RTL) — was 0 before this audit | VERIFIED |
